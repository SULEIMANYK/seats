    ...
    (
      <div
        style={{
          ...
          justifyContent: "center", alignItems: "center", background: "#f7f7f7",
          fontFamily: "sans-serif", position: "relative",
        }}
      >
        <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 96, background: "#141413" }} />
        ...
        <div style={{ position: "relative", width: 760, height: 210, display: "flex", marginTop: 40 }}>
          ...
          {[0, 1, 2, 3, 4].map((i) => seat(140 + i * 104, 124 + Math.abs(i - 2) * -5, 84, 66, i === 2 ? "#fc7428" : "rgba(20,20,19,0.10)"))}
        </div>

        <div style={{ display: "flex", fontSize: 76, fontWeight: 700, letterSpacing: -3, color: "#231f20", marginTop: 46 }}>
          seats
        </div>

        <div style={{ display: "flex", fontSize: 27, color: "rgba(35,31,32,0.62)", marginTop: 14 }}>
