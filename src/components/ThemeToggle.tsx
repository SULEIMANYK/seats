...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="inline-flex size-7 items-center justify-center rounded-full border border-[#eef2ec]/20 text-[#eef2ec]/70 transition hover:border-[#eef2ec]/40 hover:text-[#eef2ec]"
    >
      {isDark ? (
